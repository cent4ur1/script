...
yes | brew install abseil adwaita-icon-theme aom appstream autoconf automake boost borders brotli btop ca-certificates cairo cmake fastfetch fftw fileicon fontconfig freetype fribidi gdk-pixbuf gettext gh giflib git glib gobject-introspection graphene graphite2 gtk4 harfbuzz hicolor-icon-theme highway icu4c@78 imagemagick imath iproute2mac jpeg-turbo jpeg-xl libadwaita libdatrie libde265 libdeflate libepoxy libevent libfyaml libheif libmpdclient libomp libpng librsvg libsass libthai libtiff libtool libunistring libuv libvmaf libx11 libxau libxcb libxdmcp libxext libxmlb libxrender little-cms2 lpeg lua luajit luv lz4 lzo m4 miniupnpc molten-vk mpdecimal mysql nasm ncmpcpp ncurses neovim nicotine-plus ninja nowplaying-cli openexr openjdk openjph openssl@3 p7zip pango pcre2 pixman pkgconf protobuf py3cairo pygobject3 python@3.13 python@3.14 readline sevenzip shared-mime-info sketchybar skhd sqlite switchaudio-osx taglib transmission-cli tree-sitter@0.25 unibilium utf8cpp utf8proc webp x265 xorgproto xz yabai yazi yyjson zlib-ng-compat zstd 
clear
