...
yes | brew install aom autoconf automake boost borders brotli btop ca-certificates cairo cmake fastfetch fftw fileicon fontconfig freetype gettext gh giflib git glib graphite2 harfbuzz highway icu4c@78 imagemagick imath iproute2mac jpeg-turbo jpeg-xl libde265 libdeflate libevent libheif libiconv libmpdclient libomp libpng libtiff libtool libunistring libuv libvmaf libx11 libxau libxcb libxdmcp libxext libxrender little-cms2 lpeg luajit luv lz4 lzo m4 miniupnpc molten-vk mpdecimal nasm ncmpcpp ncurses neovim ninja openexr openjdk openjph openssl@3 p7zip pcre2 pixman python@3.13 python@3.14 readline sevenzip shared-mime-info sketchybar sqlite taglib transmission-cli tree-sitter@0.25 umlet unibilium utf8cpp utf8proc webp x265 xorgproto xz yazi yyjson zstd 
clear
